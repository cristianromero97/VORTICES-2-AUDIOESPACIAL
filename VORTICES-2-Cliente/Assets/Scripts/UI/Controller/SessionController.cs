...
namespace Vortices
{
    public class SessionController : MonoBehaviour
    {
        ...
        public void SetEnvironment(Toggle environmentToggle, int environmentId)
        {
            ...
            // Buscar el índice del entorno seleccionado en la lista dinámica
            int selectedIndex = -1;
            for (int i = 0; i < AddonsController.instance.environmentObjects.Count; i++)
            {
                if (AddonsController.instance.environmentObjects[i].environmentName == environmentName)
                {
                    selectedIndex = i;
                    break;
                }
            ...
            else if (environmentName == "Sala Environment")
            {
            ...
            if (selectedIndex >= 0)
            {
                AddonsController.instance.SetEnvironment(selectedIndex);
            }
