...
namespace Vortices
{
    public class SessionManager : NetworkBehaviour
    {
        ...
        private void OnSessionCreated(SessionCreatedMessage msg)
        {
            if (msg.success)
            {
                Debug.Log($"Sesi�n creada con �xito: {msg.sessionName}");
                // Aqu� puedes continuar con el flujo del cliente despu�s de recibir la confirmaci�n
            }
            else
            {
        ...
        public IEnumerator LaunchSessionCoroutine(string sessionName, int userId, string environmentName)
        {
            ...
            // ServerChangeScene NO se usa porque forzaría el cambio de escena en todos los
            ...
            // Solo llamar StartHost() si todavía no hay un servidor activo.
